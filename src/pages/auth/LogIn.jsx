    ...
    <section class="text-gris-capres-600 body-font">
      <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
        <div class="lg:w-3/5 md:w-1/2 md:pr-16  lg:pr-0 pr-0">
          <img src={Logo} alt="Logo Capres" className="mb-10 -mt-10" />
        ...
        <div class="lg:w-2/6 md:w-1/2 bg-gris-capres-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
          ...
          <div class="relative mb-4">
            ...
            <input
              ...
              id="full-name"
              name="full-name"
              class="w-full bg-white rounded border border-gris-capres-300 focus:border-azul-capres-700 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gris-capres-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
            />
          </div>
          <div class="relative mb-4">
